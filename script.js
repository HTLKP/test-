...
const products = [
    {
        ...
        description: 'اسم الحساب: mohammed_amine95 | أكثر المابات لعبًا: Emergency Emden | المميزات: أكثر من 4 Gamepass (القطار، الطائرة بدون طيار، طائرة الهليكوبتر، حزمة تعديل السيارات)',
        price: '400',
        emoji: '🎮'
    }
];
...
function initSplashScreen() {
    ...
    if (splashScreen) {
        ...
        }, 3300); // 2.5s animation + 0.8s fade out
    }
}
